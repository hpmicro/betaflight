...
const timerHardware_t fullTimerHardware[FULL_TIMER_CHANNEL_COUNT] = {
    /* PWM1 */
    {
        ...
        .pwm_out_trgm_src = HPM_TRGM1_INPUT_SRC_PWM1_CH8REF,
        .pwm_out_trgm_dst = HPM_TRGM1_OUTPUT_SRC_TRGM1_P2,
        .trgm_port_idx = 2,
#endif
        /*For dual-direct dshot*/
        .gptmr_io_function = IOC_PA22_FUNC_CTL_TRGM1_P_02,
        DSHOT_DMA_CHANNEL_RESOURCE(XDMA, HDMA, XDMA, 0,4,4)
    ...
    },
    {
        ...
        .cap_pin = TIMER_GET_IO_TAG(PA27),
        .dma_req_cmp_index = 11,
        .output = (DEF_TIM_OUTPUT(CH_CH5) | 0),
        .alternateFunction = IOC_PC01_FUNC_CTL_PWM0_P_1,
        .cmp_index = 2,
#ifndef HPM_USE_PWM_OUTPUT_DSHOT
        .pwm_out_trgm_src = HPM_TRGM1_INPUT_SRC_PWM1_CH9REF,
        .pwm_out_trgm_dst = HPM_TRGM1_OUTPUT_SRC_TRGM1_P7,
        .trgm_port_idx = 7,
#endif
        /*For dual-direct dshot*/
        .gptmr_io_function = IOC_PA27_FUNC_CTL_TRGM1_P_07,
        DSHOT_DMA_CHANNEL_RESOURCE(XDMA, HDMA, XDMA, 1,1,5)
        DSHOT_PWM_TRGM_SOURCE(PWM,1,CMP,11,TRGM,1,DMACFG,1)
        DHSOT_TELEMETRY_CAPTURE_RESOURCE(P7, GPTMR3, TRGM1, TRGM1)
    },
    {
        .tim = HPM_PWM0,
#ifdef HPM_USE_PWM_OUTPUT_DSHOT
        ...
        .pwm_out_trgm_dst = HPM_TRGM0_OUTPUT_SRC_TRGM0_P0,
        .trgm_port_idx = 0,
#endif
        /*For dual-direct dshot*/
        .gptmr_io_function = IOC_PB20_FUNC_CTL_TRGM0_P_00,
        DSHOT_DMA_CHANNEL_RESOURCE(XDMA, HDMA, XDMA, 2,2,6)
        DSHOT_PWM_TRGM_SOURCE(PWM,0,CMP,12,TRGM,0,DMACFG,2)
        DHSOT_TELEMETRY_CAPTURE_RESOURCE(P0, GPTMR0, TRGM0, TRGM0)
    },
    {
        .tim = HPM_PWM0,
#ifdef HPM_USE_PWM_OUTPUT_DSHOT
        ...
        .pwm_out_trgm_dst = HPM_TRGM0_OUTPUT_SRC_TRGM0_P1,
        .trgm_port_idx = 1,
#endif
        /*For dual-direct dshot*/
        .gptmr_io_function = IOC_PB21_FUNC_CTL_TRGM0_P_01,
        DSHOT_DMA_CHANNEL_RESOURCE(XDMA, HDMA, XDMA, 3,3,7)
        DSHOT_PWM_TRGM_SOURCE(PWM,0,CMP,13,TRGM,0,DMACFG,3)
        DHSOT_TELEMETRY_CAPTURE_RESOURCE(P1, GPTMR1, TRGM0, TRGM0)
    }
};
void timerInit(void)
{
